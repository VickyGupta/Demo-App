...
export class HomeService {
  ...
  public getFormElementListByFormId(profileId, formId) {
    return this.http.get('/api/profiles/' + profileId + '/pages/' + formId + '/elements', this.options).pipe(map(res => res.json()));
  }
